...
It (will) support technical indicators, visualizations, portfolio tracking, limit/stop orders, and a persistent holdings storage system (the CLI version of the app has these features).
